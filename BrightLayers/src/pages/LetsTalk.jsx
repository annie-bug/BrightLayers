...
function LetsTalk() {
  return (
    ...
    <div className="w-[90%] mx-auto h-[100vh] flex flex-col justify-center">
        ...
        {/*Reach Out To Us */}
        <div className=" w-[26rem] text-[#303338] text-[3.0894rem] font-semibold font-pSans leading-[3.6456rem] tracking-wide">Reach Out To Us</div>
        ...
        <div className=" w-[60%] mt-12 grid grid-cols-2 gap-12">   
                  <div> 
                  <div data-layer="Email Address" className=" w-[12.5625rem] h-[4.375rem] text-orange-500 text-[1.5625rem] font-bold font-title leading-loose tracking-tight">Email Address</div>
                  ...
                  <div>
                  <div data-layer="Contact" className=" w-[12.5625rem] h-[4.375rem] text-orange-500 text-[1.5625rem] font-bold font-title leading-loose tracking-tight">Contact</div> 
                  ...
                  <div>
                  <div data-layer="Address" className="Address w-[12.5625rem] h-[4.375rem] text-orange-500 text-[1.5625rem] font-bold font-title leading-loose tracking-tight">Address</div>
